...
public class Lotto {
	...
	private HashSet<Integer> winningNum; // 선언
	private double prizeMoney;

	public Lotto() {
		winningNum = new HashSet<Integer>(); // 사용
	}
	...
	public void makeWinningNumberMoney() {
		// 번호 생성, 당첨금 생성
		Random r = new Random();
		prizeMoney = r.nextInt(2000000000) + 1; // prizeMoney가 double type이라 int라도 double type으로 들어감
